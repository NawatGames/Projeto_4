...
public class ElementGenerator_Should {
    ...
    private SecondaryElementSO[] _mockSecundaryList;
    ...
    public void SetupAllTests() {
        ...
        _mockSecundaryList = new[] { ScriptableObject.CreateInstance<SecondaryElementSO>(), ScriptableObject.CreateInstance<SecondaryElementSO>()};
        ...
        _generator = new ElementGenerator(ref _mockSecundaryList);
    }
    
    [Test]
    public void Return_Element_At_Index_1() {
        var elementReturned = _generator.GetValueFromKey(_mockPrimeList2);
    ...
    public void Return_Element_At_Index_0() {
        var elementReturned = _generator.GetValueFromKey(_mockPrimeList1);
